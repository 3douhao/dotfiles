...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("pythonFunction", s:lightblue, "", "")
	...
	call <SID>X("pythonDottedName", s:yellow, "", "")
	" call <SID>X("pythonStrFormat", s:foreground, "", "")
	call <SID>X("pythonStrFormat", s:orange, "", "")
	" call <SID>X("pythonBuiltinFunc", s:foreground, "", "")
	call <SID>X("pythonBuiltinFunc", s:blue, "", "")
	call <SID>X("pythonBuiltinObj", s:wine, "", "")
  call <SID>X("pythonParam", s:orange, "", "")
  call <SID>X("pythonParameters", s:blue, "", "")
  call <SID>X("pythonClassParameters", s:orange, "", "")
  call <SID>X("pythonDot", s:red, "", "")
  call <SID>X("pythonBrackets", s:aqua, "", "")
